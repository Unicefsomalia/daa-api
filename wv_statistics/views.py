...
class GetAllReport(APIView):
    def get(self, request, format=None):
        ...
        # Ignore training schools
        students = students.filter(stream__school__is_training_school=False)
        schools = schools.filter(is_training_school=False)
        teachers = teachers.filter(school__is_training_school=False)
