...
def get_enrollment_stats_view(grouping, **kwargs):
    ...
    query_params["order"]= query_params.get("order","DESC")
    query_params["order_by"]= query_params.get("order_by","total_students")
...
def get_attendance_stats_view(grouping, **kwargs):
    query_params=kwargs.get("query_params",{})
    query_params["order"]= query_params.get("order","DESC")
    query_params["order_by"]= query_params.get("order_by","total_attendances_taken")
    kwargs["query_params"]=query_params
