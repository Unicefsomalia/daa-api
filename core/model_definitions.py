...
import copy
from attendance.models import ATTENDANCE_STATS_DEFAULT_FIELDS, ATTENDANCE_STATS_DEFINTIONS, ATTENDANCE_TRACKING_STATS_DEFAULT_FIELDS, ATTENDANCE_TRACKING_STATS_DEFINTIONS
from translation.models import LOCALE_TRANSLATIONS_TEXTS_DEFAULT_FIELDS, LOCALE_TRANSLATIONS_TEXTS_STATS_DEFINTIONS


STUDENT_ABSENCE_REASON_STATS_DEFINTIONS = copy.deepcopy(STUDENT_DELETE_REASON_STATS_DEFINTIONS)
STUDENT_ABSENCE_REASON_STATS_DEFAULT_RESP_FIELDS = copy.deepcopy(STUDENT_DELETE_REASON_STATS_DEFAULT_RESP_FIELDS)
...
models_definitions = {
    ...
    "StudentAbsentReason": {
        "stats_definition": STUDENT_ABSENCE_REASON_STATS_DEFINTIONS,
        "default_fields": STUDENT_ABSENCE_REASON_STATS_DEFAULT_RESP_FIELDS,
        "default_filters": {
            "is_training_school": {
                "field_name": "student__stream__school__is_training_school",
                "value": training_school_default,
    ...
    "LocaleTranslationText": {
        "stats_definition": LOCALE_TRANSLATIONS_TEXTS_STATS_DEFINTIONS,
