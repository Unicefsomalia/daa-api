...
urlpatternsv1 = [
    ...
    url("^no-attendance-historys/", include("attendance.no_attendance_historys.urls")),
    url(r"^statistics/", include("wv_statistics.urlsv1")),
    url("^states/", include("region.states.urls")),
    ...
    url("^villages/", include("region.villages.urls")),
    ...
    url("^intergrate-students/", include("school.student_intergrates.urls")),
    url("^school-transfers/", include("school.student_school_transfers.urls")),
    ...
    url("^partners/",include("school.oosc_partners.urls")), 
    url("^support-requests/", include("support_question.support_requests.urls")),
    url("^translation-locales/", include("translation.translation_locales.urls")),
    url("^translation-texts/", include("translation.translation_texts.urls")),
    url("^locale-translation-texts/", include("translation.locale_translation_texts.urls")),
]
urlpatternsv2 = [
