...
from attendance.views import GetStatsAttendanceAPIView, ListAttendanceDynamicStatisticsAPIView, ListCreateAttendancesAPIView, RetrieveUpdateDestroyAttendanceAPIView, ListCreateAttendanceStatistics, ListCreateStreamAttendance
