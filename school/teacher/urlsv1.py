...
from school.teacher.views import ListCreateTeachersAPIView, RetrieveUpdateDestroyTeacherAPIView, RetrieveSchoolInfoAPIView, ListCreateTeachersDynamicsAPIView

urlpatterns = [
    url(r"^$", ListCreateTeachersAPIView.as_view(), name="list_create_teachers"),
