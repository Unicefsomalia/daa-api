...
STUDENT_ABSENT_REASON_SUPPOERTED_STAT_TYES = [stat for stat in copy.deepcopy(STUDENT_DELETE_REASON_STATS_DEFINTIONS)]
STUDENT_ABSENT_REASON_STATS_DEFINTIONS = copy.deepcopy(STUDENT_DELETE_REASON_STATS_DEFINTIONS)
STUDENT_ABSENT_REASON_STATS_DEFAULT_RESP_FIELDS = copy.deepcopy(STUDENT_DELETE_REASON_STATS_DEFAULT_RESP_FIELDS)
