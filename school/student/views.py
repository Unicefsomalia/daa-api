...
from school.student.serializers import ReactivateLeanerSerializer, StudentSerializer, DeleteStudentSerializer, BulkStudentSerializer, EnrollmentSerializer, AbsentStudentSerializer
...
class ListCreateStudentsAPIView(FilterBasedOnRole, generics.ListCreateAPIView):
    ...
    queryset = (
        Student.objects.all()
        .select_related("village", "guardian_village")
        .prefetch_related(
            "special_needs",
...
class RetrieveReactivatestudent(generics.UpdateAPIView):
    queryset = Student.objects.all()
    serializer_class = ReactivateLeanerSerializer
    permission_classes = (IsAuthenticated,)
...
class ListDropoutStudents(FilterBasedOnRole, generics.ListAPIView):
    ...
    extra_filter_fields = [
        ...
        {"field_name": "created__date", "label": "Dropout Date", "field_type": "date"},
