...
class SearchSchoolSerializer(serializers.Serializer):
...
class SchoolSerializer(serializers.ModelSerializer):
    ...
    district = serializers.CharField(source="village.district_id", read_only=True,default=None)
    region = serializers.CharField(source="village.district.region_id", read_only=True,default=None)
    state = serializers.CharField(source="village.district.region.state_id", read_only=True,default=None)
...
class ImportStudentSerializer(serializers.Serializer):
    ...
    guardian_name = serializers.CharField(max_length=20, required=False)
