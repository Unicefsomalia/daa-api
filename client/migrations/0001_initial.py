    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('A', 'Admin'), ('SCHA', 'School Admin'), ('SCHT', 'School Teacher'), ('SHYA', 'Shahiya Admin'), ('DSTA', 'District Admin'), ('RGNA', 'Region Admin')], default='A', max_length=45)),
                ...
                ('gender', models.CharField(choices=[('M', 'Male'), ('F', 'Female'), ('NS', 'Not Set')], default='NS', max_length=5)),
                ...
                ('filter_args', models.CharField(blank=True, max_length=1000, null=True)),
