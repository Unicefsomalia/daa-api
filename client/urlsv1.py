...
from client.users.views import ListCreateAdminCredentials
from client.views import DeactiveTeacherProfileAccount, RetrieveUpdateClient, CreateListUser, ForgotPasswordView, ChangePasswordAPiView, ResetPasswordView, ResendVerifyEmailView, RetrieveUpdateUser, ResetTeacherPassword
from school.teacher.views import RetrieveSchoolInfoAPIView

urlpatterns = [
    url(r"^$", CreateListUser.as_view(), name="list_create_clients"),
    url(r"^system/?$", ListCreateAdminCredentials.as_view(), name="list_create_system_users"),
    ...
    url(r"^me/deactivate/?$", DeactiveTeacherProfileAccount.as_view(), name="deactive_teacher_profile"),
