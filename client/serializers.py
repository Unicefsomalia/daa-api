...
ROLE_MAPPINGS = {MyUserRoles.A.name: {"field"}}


class DeactiveTeacherAccountSerializer(serializers.Serializer):
    pass
...
class MyUserSerializer(serializers.ModelSerializer):
    ...
    is_training_school = serializers.BooleanField(source="teacher.school.is_training_school", read_only=True)
